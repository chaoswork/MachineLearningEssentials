...
sys.path.append('.')
from mle.supervised_learning.decision_tree import C45ClassificationTree
...
c45 = C45ClassificationTree(min_data_in_leaf=0)
c45.fit(train_features, train_targets)
print(c45)

predicted = c45.predict(test_features)
